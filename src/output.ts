...
function mihomoToSingbox(proxies: Proxy[]): Record<string, unknown> {
  ...
  return {
    ...
    route: {
      ...
      rule_set: [
        { tag: 'geosite-cn', type: 'remote', format: 'binary', url: 'https://gh-proxy.org/raw.githubusercontent.com/SagerNet/sing-geosite/rule-set/geosite-cn.srs', download_detour: 'direct' },
        { tag: 'geosite-geolocation-!cn', type: 'remote', format: 'binary', url: 'https://gh-proxy.org/raw.githubusercontent.com/SagerNet/sing-geosite/rule-set/geosite-geolocation-!cn.srs', download_detour: 'direct' },
        { tag: 'geosite-category-ads-all', type: 'remote', format: 'binary', url: 'https://gh-proxy.org/raw.githubusercontent.com/SagerNet/sing-geosite/rule-set/geosite-category-ads-all.srs', download_detour: 'direct' },
        { tag: 'geoip-cn', type: 'remote', format: 'binary', url: 'https://gh-proxy.org/raw.githubusercontent.com/SagerNet/sing-geoip/rule-set/geoip-cn.srs', download_detour: 'direct' },
      ],
